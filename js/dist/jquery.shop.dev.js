...
(function ($) {
  ...
  $.Shop.prototype = {
    init: function init() {
      // Properties
      this.cartPrefix = "xquizit-"; // Prefix string to be prepended to the cart's name in the session storage
      ...
      this.$purchaseForm = this.$element.find("#purchase-form"); // Purchase form

      this.currency = "ZAR"; // HTML entity of the currency to be displayed in the layout

      this.currencyString = "R"; // Currency symbol as textual string
      //this.paypalCurrency = "USD"; // PayPal's currency code
      //this.paypalBusinessEmail = "sb-ugzbc4010128@business.example.com "; // Your Business PayPal's account email address
    ...
    displayUserDetails: function displayUserDetails() {
    ...
    handleAddToCartForm: function handleAddToCartForm() {
      var self = this;
    ...
    handleCheckoutOrderForm: function handleCheckoutOrderForm() {
      var self = this;
     ...
     */
    _formatNumber: function _formatNumber(num, places) {
     ...
     */
    _extractPrice: function _extractPrice(element) {
      var self = this;
     ...
     */
    _convertString: function _convertString(numStr) {
      var num;
     ...
     */
    _convertNumber: function _convertNumber(n) {
      var str = n.toString();
      return str;
    },
     ...
     */
    _toJSONObject: function _toJSONObject(str) {
     ...
     */
    _toJSONString: function _toJSONString(obj) {
     ...
     * @returns void
     */
    _addToCart: function _addToCart(values) {
     ...
     */
    _calculateShipping: function _calculateShipping(qty) {
      var shipping = 0;
     ...
     */
    _validateForm: function _validateForm(form) {
      var self = this;
     ...
     * @returns void
     */
    _saveFormData: function _saveFormData(form) {
      var self = this;
      var $visibleSet = form.find("fieldset:visible");
      $visibleSet.each(function () {
        var $set = $(this);
